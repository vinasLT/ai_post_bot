...
class MainMenuActions(str, Enum):
    ...
    GENERATE_POST_MANUALLY = "generate_post_manually"
...
def main_menu_keyboard():
    ...
    builder.button(text="Generate Post Manually", callback_data=MainMenuCallback(action=MainMenuActions.GENERATE_POST_MANUALLY).pack())
    builder.adjust(1)
