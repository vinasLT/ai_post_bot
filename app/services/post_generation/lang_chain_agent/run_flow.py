...
from app.services.post_generation.lang_chain_agent.nodes import lot_chooser_agent_node, lot_chooser_tools, images_processing_agent, \
...
MIN_LOTS_LOT_CHOOSER = 10  # minimum lots required before sending to the user
MAX_LOTS_LOT_CHOOSER = 35  # maximum lots to collect per lot-chooser pass
FINAL_LOTS_COUNT = 35  # maximum lots in the final shortlist (not a minimum)
...
async def run_flow(filters: Filters, user_uuid: str, editable_message_id: int) -> AgentsState:
    ...
    context: AgentsRuntimeContext = {
        ...
        "min_lots_count": MIN_LOTS_LOT_CHOOSER,
